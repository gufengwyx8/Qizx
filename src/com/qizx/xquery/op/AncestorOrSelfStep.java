...
/**
 * Implementation of path step ancestor-or-self:: .
 */
public class AncestorOrSelfStep extends AncestorStep
{
    public AncestorOrSelfStep(NodeFilter nodeTest)
    {
        super(nodeTest);
    }
        ...
        throws EvaluationException
    {
        ...
        try {
            XQValue s = focus.currentItem().basicNode().getAncestorsOrSelf(nodeTest);
