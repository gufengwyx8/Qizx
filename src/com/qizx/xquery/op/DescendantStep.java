...
/**
 * Implementation of path step descendant:: .
 */
public class DescendantStep extends BasicStep
{
    public DescendantStep() {
        super(null);
    }

    public DescendantStep(NodeFilter nodeTest)
    {
        super(nodeTest);
    }
        ...
        throws EvaluationException
    {
        ...
        try {
            return focus.currentItem().basicNode().getDescendants(nodeTest);
        }
    ...
    public int getFlags()
    {
        return DOCUMENT_ORDER + WITHIN_SUBTREE;
    }
}
