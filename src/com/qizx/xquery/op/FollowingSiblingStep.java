...
/**
 * class FollowingSiblingStep:
 */
public class FollowingSiblingStep extends BasicStep
{

    public FollowingSiblingStep(NodeFilter nodeTest)
    {
        super(nodeTest);
    }
        ...
        throws EvaluationException
    {
        ...
        try {
            return focus.currentItem().basicNode().getFollowingSiblings(nodeTest);
        }
