...
/**
 *  Implementation of function fn:seconds-from-duration.
 */
public class SecondsFromDuration extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("seconds-from-duration", XQType.DOUBLE.opt, Exec.class)
    ...
    public static class Exec extends Function.DoubleCall
    {
            ...
            throws EvaluationException
        {
            ...
            case XQType.QT_DUR:
                return v.getDuration().getSeconds();
            default:
