...
/**
 *  Implementation of function fn:day-from-date.
 */
public class DayFromDate extends Function
{    
    static Prototype[] protos = { 
        Prototype.fn("day-from-date", XQType.INTEGER.opt, Exec.class).arg("op", XQType.DATE.opt)
    };
