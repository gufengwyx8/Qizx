...
/**
 *  Implementation of function fn:minutes-from-dateTime.
 */
public class MinutesFromDateTime extends Function
{    
    static Prototype[] protos = { 
        Prototype.fn("minutes-from-dateTime", XQType.INTEGER.opt, Exec.class)
            ...
            throws EvaluationException
        {
            ...
            case XQType.QT_UNTYPED:
                try {
                    ...
                    context.error(Conversion.ERR_CAST, args[0],
                                  "cannot cast to xs:dateTime: "
                                      + e.getMessage());
                    return 0;
                }
            default:
                context.invalidArgType(args[0], 0, v.getType(), "dateTime");
            }
            return 0;
        }
    }
