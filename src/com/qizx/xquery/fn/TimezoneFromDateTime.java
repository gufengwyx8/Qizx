...
/**
 *  Implementation of function fn:timezone-from-dateTime.
 */
public class TimezoneFromDateTime extends Function {
    
    static Prototype[] protos = { 
        Prototype.fn("timezone-from-dateTime", XQType.DURATION.opt, Exec.class).arg("op", XQType.DATE_TIME.opt)
    };
    ...
    public static class Exec extends Function.Call
    {
            ...
            throws EvaluationException
        {
            ...
            if (v instanceof MomentValue)
                ...
                try {
                    dt = DateTime.parseDateTime(v.getString());
                }
            ...
            try {
                ...
                return SingleDuration.newDT(Duration.newDayTime(tz * 60));
            }
            catch (DateTimeException e) {
                return context.error(Conversion.ERR_CAST, this,
