...
public class Trace extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("trace", XQType.ITEM.star, Exec.class)
            .arg("value", XQType.ITEM.star)
            .arg("label", XQType.STRING)
    };
    ...
    public static class Exec extends Function.Call
    {
        ...
        {
            context.at(this);
            TraceObserver tracer = context.getTraceListener();
            
            XQValue v = args[0].eval(focus, context);
            String label = args[1].evalAsString(focus, context);
            
            if(tracer != null) {
                tracer.trace(context.newStackTrace(this, null),
                             new ResultSequence(v.bornAgain()), label);
            }
            return v;
        }
    }
