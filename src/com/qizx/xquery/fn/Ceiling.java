...
public class Ceiling extends Function {
    ...
    static Prototype[] protos = { 
        Prototype.fn("ceiling", XQType.NUMERIC.opt, Exec.class)
    ...
    public static class Exec extends Function.Call
    {
        ...
        throws EvaluationException
        {
            ...
            case XQType.QT_UNTYPED:
                return new SingleDouble(Math.ceil(arg.getDouble()));
            case XQType.QT_FLOAT:
                return new SingleFloat((float) Math.ceil(arg.getFloat()));
            case XQType.QT_DEC:
                return new SingleDecimal(
                   arg.getDecimal().setScale(0, BigDecimal.ROUND_CEILING));
            case XQType.QT_INT:
