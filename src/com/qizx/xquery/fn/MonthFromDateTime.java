...
/**
 *  Implementation of function fn:month-from-dateTime.
 */
public class MonthFromDateTime extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("month-from-dateTime", XQType.INTEGER.opt, Exec.class).arg("op", XQType.DATE_TIME.opt)
    };
