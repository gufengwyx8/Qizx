...
/**
 *  Implementation of function fn:seconds-from-time.
 */
public class SecondsFromTime extends Function
{    
    static Prototype[] protos = { 
        Prototype.fn("seconds-from-time", XQType.DOUBLE.opt, Exec.class)
