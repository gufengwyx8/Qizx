...
/**
 *  Implementation of function fn:years-from-duration.
 */
public class YearsFromDuration extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("years-from-duration", XQType.INTEGER.opt, Exec.class)
