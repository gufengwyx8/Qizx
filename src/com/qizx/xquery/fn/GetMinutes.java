...
/**
 *  Implementation of function fn:get-minute (replaces minutes-from-***).
 *  Works on: time, dateTime, duration
 */
public class GetMinutes extends Function {
    
    static Prototype[] protos = { 
        Prototype.fn("get-minutes", XQType.INTEGER.opt, Exec.class)
