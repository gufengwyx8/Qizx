...
/**
 *  Implementation of function fn:minutes-from-time.
 */
public class MinutesFromTime extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("minutes-from-time", XQType.INTEGER.opt, Exec.class)
