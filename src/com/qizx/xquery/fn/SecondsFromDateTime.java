...
/**
 *  Implementation of function fn:seconds-from-dateTime.
 */
public class SecondsFromDateTime extends Function {
    
    static Prototype[] protos = { 
        Prototype.fn("seconds-from-dateTime", XQType.DOUBLE.opt, Exec.class)
    ...
    public static class Exec extends Function.DoubleCall
    {
            ...
            throws EvaluationException
        {
            ...
            try {
                ...
                context
                    .error(Conversion.ERR_CAST, this,
