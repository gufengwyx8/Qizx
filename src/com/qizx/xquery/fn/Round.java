...
/**
 *  Implementation of function fn:round.
 */
public class Round extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("round", XQType.NUMERIC.opt, Exec.class)
    ...
    public static class Exec extends Function.Call
    {
            ...
            throws EvaluationException
        {
            ...
            case XQType.QT_UNTYPED:
                return new SingleDouble(Math.rint(arg.getDouble()));
            case XQType.QT_FLOAT:
                return new SingleFloat((float) Math.rint(arg.getFloat()));
            case XQType.QT_DEC:
                return new SingleDecimal(Conversion.round(arg.getDecimal()));
            case XQType.QT_INT:
