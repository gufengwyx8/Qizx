...
/**
 * Implementation of function fn:ends-with.
 */
public class EndsWith extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("ends-with", XQType.BOOLEAN.opt, Exec.class)
        .arg("op1", XQType.STRING.opt) .arg("op2", XQType.STRING.opt),
        Prototype.fn("ends-with", XQType.BOOLEAN.opt, Exec.class)
        .arg("op1", XQType.STRING.opt) .arg("op2", XQType.STRING.opt)
    ...
    public static class Exec extends Function.BoolCall
    {
            ...
            throws EvaluationException
        {
            ...
            context.at(this);
            return Collations.endsWith(s1, s2, collator);
        }
    }
}
