...
/**
 *  Implementation of function fn:days-from-duration.
 */
public class DaysFromDuration extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("days-from-duration", XQType.INTEGER.opt, Exec.class)
