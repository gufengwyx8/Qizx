...
/**
 *  Implementation of function fn:minutes-from-duration.
 */
public class MinutesFromDuration extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("minutes-from-duration", XQType.INTEGER.opt, Exec.class)
    ...
    public static class Exec extends Function.IntegerCall
    {
            ...
            throws EvaluationException
        {
            ...
            case XQType.QT_DUR:
                return v.getDuration().getMinutes();
            default:
