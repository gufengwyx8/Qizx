...
/**
 * Implementation of function fn:hours-from-dateTime.
 */
public class HoursFromDateTime extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("hours-from-dateTime", XQType.INTEGER.opt, Exec.class).arg("op", XQType.DATE_TIME.opt)
    };
