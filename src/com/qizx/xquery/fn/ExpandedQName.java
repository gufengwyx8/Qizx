...
public class ExpandedQName extends Function
{
    static Prototype[] protos = { 
        Prototype.fn("expanded-QName", XQType.QNAME, Exec.class)
            .arg("namespaceURI", XQType.STRING)
            .arg("localPart", XQType.STRING)
    };
    ...
    public static class Exec extends Function.Call
    {
            ...
            throws EvaluationException
        {
            ...
            com.qizx.api.QName name =
                IQName.get(args[0].evalAsString(focus, context),
