...
/**
 *  Implementation of function fn:year-from-dateTime.
 */
public class YearFromDateTime extends Function
{    
    static Prototype[] protos = { 
        Prototype.fn("year-from-dateTime", XQType.INTEGER.opt, Exec.class).arg("op", XQType.DATE_TIME.opt)
    };
