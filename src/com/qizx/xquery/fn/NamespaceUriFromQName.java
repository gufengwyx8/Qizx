 ...
 */
public class NamespaceUriFromQName extends Function
{    
    static Prototype[] protos = { 
        Prototype.fn("namespace-uri-from-QName", XQType.ANYURI.opt, Exec.class)
    ...
    public static class Exec extends Function.Call
    {
            ...
            throws EvaluationException
        {
            ...
            return new SingleString(item.getQName().getNamespaceURI(),
                                    XQType.ANYURI);
        }
    }
}
