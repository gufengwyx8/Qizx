...
/**
 *  Implementation of function fn:get-years (replaces years-from-***).
 */
public class GetYears extends Function {
    
    static Prototype[] protos = { 
        Prototype.fn("get-years", XQType.INTEGER.opt, Exec.class)
        .arg("op", XQType.DATE.opt),
        Prototype.fn("get-years", XQType.INTEGER.opt, Exec.class)
        .arg("op", XQType.DATE_TIME.opt),
        Prototype.fn("get-years", XQType.INTEGER.opt, Exec.class)
        .arg("op", XQType.G_YEAR.opt),
        Prototype.fn("get-years", XQType.INTEGER.opt, Exec.class)
